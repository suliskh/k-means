 ...
 */
var assignCluster = function assignCluster(data, centeroids, N) {
    var nearestCenteroid = 0;
    var euclidian = 0;
...
var __ = require('./utils.js');
var getRandomCenteroids = require('./random-centeroids.js');
var doKMeans = require('./k-means.js');
 ...
 */
var doKMeansFromLocal = function doKMeansFromLocal(input) {
    papa.parse(input.files[0], {
        dynamicTyping: true,
        complete: function complete(results) {
            var data = results.data;
            var centeroids = KMeans.getInitialCenteroids(data, PROPS.K); // dummy centeroids
...
},{"./k-means.js":4,"./random-centeroids.js":6,"./save.js":7,"./utils.js":8,"papaparse":1}],4:[function(require,module,exports){
'use strict';

var assignCluster = require('./assign-cluster.js');
var moveCenteroids = require('./move-centeroids.js');
 ...
 * @param {Object} props
 */
var doKMeans = function doKMeans(data, centeroids, props) {
    var oCenteroids = [];
...
},{"./assign-cluster.js":2,"./move-centeroids.js":5}],5:[function(require,module,exports){
'use strict';
 ...
 * @param {int} n number of dimension
 */
var moveCenteroids = function moveCenteroids(data, centeroids, n) {
    // loop through centeroids point
    for (var c = 0; c < centeroids.length; c++) {
        var obj = [];
        var sumCount = 0;
 ...
 */
var getRandomCenteroids = function getRandomCenteroids(data, k) {
    var centeroids = [];
    for (var i = 0; i < k; i++) {
 ...
 */
var save = function save(dataString) {
 ...
 * @return {number}
 */
var getEuclidianDistance = function getEuclidianDistance(x, y, n) {
    var sum = 0;
    for (var i = 0; i < n; i++) {
 ...
 */
var getSumCount = function getSumCount(data, d, c, n) {
